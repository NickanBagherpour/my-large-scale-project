...
import { Box as UiKitBox, type ColumnsType, Table, Tooltip } from '@oxygen/ui-kit';
...
export default function Scope() {
  ...
  const desktopColumns: ColumnsType<ScopeType> = [
    ...
    },
    {
      ...
      render: (description) => <Tooltip title={getValueOrDash(description)}>{getValueOrDash(description)}</Tooltip>,
    },
  ];
