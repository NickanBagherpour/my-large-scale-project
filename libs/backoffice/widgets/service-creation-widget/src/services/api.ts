...
import type { Category, PostServiceParams, Route, Service, Tags, Upstreams, UpstreamWithTargets } from '../types';
...
const Api = {
  ...
  getCategories: async () => client.get<Category[]>(`${portalUrl}/v1/service-categories`),
};
export default Api;
