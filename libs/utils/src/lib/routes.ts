...
export const ROUTES = {
  ...
  BUSINESS: {
    ...
    CLIENTS_REPORT_META: '/clients-report-meta',
    SERVICES_REPORT_META: '/services-report-meta',
  },
};
...
export const BUSINESS_ROUTE_GROUPS = [
  ...
  [ROUTES.BUSINESS.CLIENTS_REPORT, ROUTES.BUSINESS.CLIENTS_REPORT_META],
  [ROUTES.BUSINESS.SERVICES_REPORT, ROUTES.BUSINESS.SERVICES_REPORT_META],
];
