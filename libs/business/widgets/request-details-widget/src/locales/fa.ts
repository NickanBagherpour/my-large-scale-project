export default {
  ...
  request_details_client: 'جزئیات درخواست کلاینت {{clientName}}',
  ...
  organization_representative_name: 'نام نماینده شرکت',
  ...
  reject_request: 'رد درخواست',
  description: 'توضیحات...',
  confirm_message_with_aggregator:
    'آیا درخواست کلاینت {{clientName}} مربوط به {{aggregatorName}} را {{messageType}} می‌کنید؟',
  confirm_message_no_aggregator: 'آیا درخواست کلاینت {{clientName}} را {{messageType}} می‌کنید؟',
  confirm: 'تایید',
  reject: 'رد',
  // confirm_question_first: 'آیا درخواست کلاینت',
  // confirm_question_second: ' مربوط به {{aggregatorName}} را تایید می‌کنید؟',
  // reject_question_second: ' مربوط به {{aggregatorName}} را رد می‌کنید؟',
  // confirm_question_no_aggregator: ' را تایید می‌کنید؟',
  // reject_question_no_aggregator: ' را رد می‌کنید؟',
