...
export const createGetInfoSchema = (t: TFunction) =>
	z.object({
		...
		[FORM_ITEM_NAMES.actionOrMethod]: z.string({ required_error: t('validation.required') }).min(1, { message: t('validation.required') }),
		...
		[FORM_ITEM_NAMES.version]: z.string({ required_error: t('validation.required') }).min(1, { message: t('validation.required') }),
		[FORM_ITEM_NAMES.owner]: z.string({ required_error: t('validation.required') }).min(1, { message: t('validation.required') }),
		[FORM_ITEM_NAMES.tag]: z.string().refine((val) => val, t('validation.choose_one_option')),
		[FORM_ITEM_NAMES.path]: z.string({ required_error: t('validation.required') }).min(1, { message: t('validation.required') }),
		[FORM_ITEM_NAMES.host]: z.string({ required_error: t('validation.required') }).min(1, { message: t('validation.required') }),
